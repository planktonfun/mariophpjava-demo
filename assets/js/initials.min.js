var Neuron=synaptic.Neuron,Layer=synaptic.Layer,Network=synaptic.Network,Trainer=synaptic.Trainer,Architect=synaptic.Architect,perimeter=13,perceptron=null,learningRate=0.12,actions=[1,2,3,5,0],fpsstart=30,fitness=0,currentscore=0,currentright=0,symbols=[0,1,2,3,4,5,6,7,8],percievedActions={},totalFitness=0,lastFitness=0,totaliteration=0,rawActions="",Gene=function(a){0<a.length&&(this.code=a);this.cost=9999};Gene.prototype.code=[];Gene.prototype.random=function(){this.code=generateActions()};
