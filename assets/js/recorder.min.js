var limiters=!1,playback=!1,playiteration=0,recordings={};function getMicroseconds(){return Math.floor(1E3*(getMicrotime(!0)-initialTimestamp))}function getMicrotime(a){var b,c;"undefined"!==typeof performance&&performance.now?(b=(performance.now()+performance.timing.navigationStart)/1E3,c=1E6):(b=(Date.now?Date.now():(new Date).getTime())/1E3,c=1E3);return a?b:Math.round((b-(b|0))*c)/c}
